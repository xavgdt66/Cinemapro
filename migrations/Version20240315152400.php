 ...
 */
final class Version20240315152400 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE salle ADD user_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE user ADD nombre_salles INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP nombre_salles');
    }
}
